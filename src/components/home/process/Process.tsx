...
const Process = () => {
  ...
  return (
    <div className=" flex justify-center">
      <div className=" my-16 px-4 md:px-6 lg:px-16 xl:px-24  max-w-[1280px]">
        ...
        {dataProcess.map((data, index) => (
          <div
            ...
            <div className=" flex flex-col gap-4 justify-between relative md:w-[560px] lg:w-[720px]">
              {index !== 0 && (
                <div className="absolute h-10 border rounded-md border-red-500 -top-11 hidden lg:block" />
              )}
              <Typography className="title3">
                <span style={{color: '#FF1C03'}}>0{index + 1}</span>{' '}
                {data.title}
              </Typography>
